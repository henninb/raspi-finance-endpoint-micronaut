...
object Constants {
    ...
    const val ALPHA_NUMERIC_NO_SPACE = ALPHA_NUMERIC_NO_SPACE_PATTERN
    const val MUST_BE_ASCII_MESSAGE = FIELD_MUST_BE_ASCII_MESSAGE
    const val MUST_BE_UUID_MESSAGE = FIELD_MUST_BE_UUID_MESSAGE
    const val MUST_BE_ALPHA_UNDERSCORE_MESSAGE = FIELD_MUST_BE_ALPHA_SEPARATED_BY_UNDERSCORE_MESSAGE
    const val MUST_BE_DOLLAR_MESSAGE = FIELD_MUST_BE_A_CURRENCY_MESSAGE
    const val MUST_BE_NUMERIC_NO_SPACE = FIELD_MUST_BE_NUMERIC_NO_SPACE_MESSAGE
    const val TRANSACTION_REST_REOCCURRING_STATE_UPDATE_FAILURE_COUNTER = TRANSACTION_REST_REOCCURRING_TYPE_UPDATE_FAILURE_COUNTER
}