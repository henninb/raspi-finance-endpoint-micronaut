...
open class TransactionService(
    ...
    @Timed
    open fun deleteReceiptImage(transaction: Transaction) {
    ...
    @Timed
    open fun createDefaultAccount(accountNameOwner: String, accountType: AccountType): Account {
        val account = Account()
    ...
    @Timed
    open fun masterTransactionUpdater(transactionFromDatabase: Transaction, transaction: Transaction): Boolean {
...
//    }
    ...
    @Timed
    open fun createThumbnail(rawImage: ByteArray, imageFormatType: ImageFormatType): ByteArray {
        try {
    ...
    @Timed
    open fun getImageFormatType(rawImage: ByteArray): ImageFormatType {
    ...
    @Timed
    open fun nextTimestampMillis(): Long {
