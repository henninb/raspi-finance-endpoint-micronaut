...
data class MedicalExpenseInputDto(
    ...
    @field:Pattern(regexp = "^[A-Z0-9-]*$", message = "Procedure code can only contain uppercase letters, numbers, and hyphens")
    val procedureCode: String? = null,
    @field:Size(max = 20, message = "Diagnosis code cannot exceed 20 characters")
    @field:Pattern(regexp = "^[A-Z0-9.-]*$", message = "Diagnosis code can only contain uppercase letters, numbers, periods, and hyphens")
    ...
    @field:Pattern(regexp = "^[A-Z0-9-]*$", message = "Claim number can only contain uppercase letters, numbers, and hyphens")
